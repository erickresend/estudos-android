package com.erickresend.retrofit_canal_mobilizando
...
import com.erickresend.retrofit_canal_mobilizando.api.Endpoint
import com.erickresend.retrofit_canal_mobilizando.util.NetworkUtils
...
class MainActivity : AppCompatActivity() {
    ...
    fun getCurrencies() {
        val retrofitClient = NetworkUtils.getRetrofitInstance("https://cdn.jsdelivr.net/")
        //pelo que entendi cria o objeto pelo endpoint
        val endpoint = retrofitClient.create(Endpoint::class.java)
